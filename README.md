...
* `med-res-ocr-jfk20250318-1930h.pdf` OCR - medium quality - all 31,419 pages from 20250318-1930h.   Original filenames from the US National Archives are embedded in the text with punctuation removed -- these references can be used to go back to the original image file version.

* `med-res-ocr-jfk2025038-supplemental.pdf` OCR - medium quality - all 489 pages from supplemental drop.

* `med-res-ocr-jfk20250320-2130h.pdf` OCR - medium quality - all 14,318 pages from 20250320-2130h.   Original filenames from the US National Archives are embedded in the text with punctuation removed -- these references can be used to go back to the original image file version.
