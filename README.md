...
| pdf/20250320-1900h        | 207   | 704    | 5th drop from NARA                                       |

## OCR and Bates stamped pages derived from NARA files above
...
| med-res-ocr-jfk20250403-1900h.pd         | 207   | 704    |

## Text extracted from the OCR and Bate stamped files
...
| 20250403-1900h-extracted-text.txt         | 704    |

## Word histograms of 3 letter and longer words extracted from the OCR and Bate stamped files
| Word Histograms                          |
|------------------------------------------|
| 20250318-1930h-word-histogram.txt        |
| 20250318-2230h-word-histogram.txt        |
| 20250318-supplemental-word-histogram.txt |
| 20250320-2130h-word-histogram.txt        |
| 20250326-1530h-word-histogram.txt        |
| 20250403-1900h-word-histogram.txt        |

```
├── LICENSE
├── README.md
├── med-res-ocr-jfk20250318-1930h.pdf [31,419 page OCR original 1123 files]
├── med-res-ocr-jfk20250318-2230h.pdf [YYYYYY page OCR original 1059 files]
...
├── med-res-ocr-jfk20250326-1530h.pdf [53 page OCR original 16 files]
├── med-res-ocr-jfk20250403-1900h.pdf [704 page OCR original 207 files]
├── pdf
...
│   │   └── *.pdf
│   ├── 20250326-1530h [53 files of original drop, canonical naming]
│   │   └── *.pdf
│   ├── 20250403-1900h [704 files of original drop, canonical naming]
│   │   └── *.pdf
│   ├── sha256-20250318-1930h.txt
│   ├── sha256-20250318-2230h.txt
│   ├── sha256-20250318-supplemental.txt
│   └── sha256-20250320-2130h.txt
│   └── sha256-20250326-1530h.txt
│   └── sha256-20250403-1900h.txt
├── 20250318-1930h-extracted-text.txt
├── 20250318-2230h-extracted-text.txt
├── 20250318-supplemental-extracted-text.txt
├── 20250320-2130h-extracted-text.txt
├── 20250326-1530h-extracted-text.txt
├── 20250403-1900h-extracted-text.txt
├── 20250318-1930h-word-histogram.txt
├── 20250318-2230h-word-histogram.txt
├── 20250318-supplemental-word-histogram.txt
├── 20250320-2130h-word-histogram.txt
├── 20250326-1530h-word-histogram.txt
└── 20250318-1900h-word-histogram.txt
```
* 
